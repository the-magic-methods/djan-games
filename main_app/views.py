...
def games_detail(request, game_id):
    ...
    return render(
        request, "games/detail.html", {"game": game, "score_form": score_form}
    )
...
def scores_index(request):
    ...
    return render(
        request,
        "games/leaderboards.html",
        {"games": games, "score": score, "first": first},
    )
...
def profile_page(request):
    ...
    return render(
        ...
        {"games": games, "profile": profile, "profile_form": profile_form},
    )
...
def Connect_Four(request):
  return render(request, 'games/Connect_Four.html')
